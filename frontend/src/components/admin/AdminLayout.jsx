    ...
    <div className="flex min-h-screen bg-zinc-950">
        ...
        <div className="border-t border-white/10 p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="truncate text-xs text-white/50">{admin?.role}</p>
            </div>
          </div>
          <button
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-4 border-b border-white/10 bg-zinc-950/95 px-4 backdrop-blur lg:px-6">
          ...
          <button
            onClick={() => navigate('/')}
            className="shrink-0 rounded-lg border border-white/10 px-3 py-1.5 text-xs font-medium text-white/60 transition hover:border-white/20 hover:text-white"
          >
            View Site
          </button>
        </header>
